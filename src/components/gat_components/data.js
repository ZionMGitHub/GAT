...
export const data = {
    'story' : {
        ...
        text: ['Tensions have been rising between the Gods and the Titans and now they\'re gearing up to see who will prevail, in a battle that will decide who rules the universe. Now it\'s time to pick your side of history, armor up and join the battle by owning a Gods and Titans NFT. ',
                'Every NFT character is crafted by our very own DC Comics artist and integrates into a Comic NFT. So by owning one, you also get exclusive access to The Comic Studio (part of the world\'s first Comicverse) where you can create your own free Comic NFTs.'
            ],
    ...
    'acropolis':{
     ...
     'comic' : {
        ...
        text: [
            'Once you\'ve minted your free comic NFT in the Comic Studio, you\'ll have full control over it. You\'ll be able to hold it or sell it on the secondary market and earn royalties on it',
            'As you can see, not only do Gods & Titans NFTs generate multiple streams of passive income for collectors, but so too do your free Comic NFTs. Check out our whitepaper for more details on our investment opportunities for collectors.'
    ...
    'roadmapText':{
        title: 'roadmap',
        text: ['Our Project Roadmap is split into 2 Phases. In Phase 1 there will be 3 drops of 4000 Gods and Titans NFTs. Following this, Phase 2 will see the launch of the Comic Studio, along with Comic Book NFT Series 1 - Titanomachy, Comic Book NFT Series 2 - Golden Fleece, Comic Book NFT Series 3 - Trojan War.']
    },
    'roadmap': [
        {
            title: 'Drop 1:',
